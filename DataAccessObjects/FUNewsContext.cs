...
public partial class FUNewsContext : DbContext
{
    ...
    {
        // The application configures SQL Server via dependency injection in Program.cs.
        // Keep this empty to avoid shipping a hard-coded connection string in source code.
    }
